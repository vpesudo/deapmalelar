...
def main():
	...
	#Alternativamente, podemos cargar un modelo guardado. Este comando compila el modelo directamente.
	...
	filename = "./r_error_ANN_epochs%d_2HL_%d_%d_%d__%d_%d_binaryclass.txt" % (nepochs, neurons[0],neurons[1],neurons[2],cutlow,cuthigh)
	fh = open(filename, "w")
	...
	#filename = "./model_ANN_epochs%d_2HL_%d_%d_%d__%d_%d_binaryclass.h5" % (nepochs, neurons[0],neurons[1],neurons[2],cutlow,cuthigh)
	#model.save(filename)
	...
	plt.hist(errors, 40)
	plt.title('Error X')
	filename = "./histerrors_ANN_epochs%d_2HL_%d_%d_%d__%d_%d_binaryclass.eps" % (nepochs, neurons[0],neurons[1],neurons[2],cutlow,cuthigh)
	...
	filename = "./loss_ANN_epochs%d_2HL_%d_%d_%d__%d_%d_binaryclass.eps" % (nepochs, neurons[0],neurons[1],neurons[2],cutlow,cuthigh)
	plt.savefig(filename)
	...
	plt.ylim(-1.1,1.1)
	plt.legend(['train', 'test'], loc='upper left')
	filename = "./scatterplotr_ANN_epochs%d_2HL_%d_%d_%d__%d_%d_binaryclass.eps" % (nepochs, neurons[0],neurons[1],neurons[2],cutlow,cuthigh)
	plt.savefig(filename)
	...
	filename = "./scatterplot_TruevsPred_ANN_epochs%d_2HL_%d_%d_%d__%d_%d_binaryclass.eps" % (nepochs, neurons[0],neurons[1],neurons[2],cutlow,cuthigh)
	...
	plt.ylim(-1.1,1.1)
	plt.legend(['train', 'test'], loc='upper left')
	filename = "./scatterplotch_ANN_epochs%d_2HL_%d_%d_%d__%d_%d_binaryclass.eps" % (nepochs, neurons[0],neurons[1],neurons[2],cutlow,cuthigh)
	#plt.savefig(filename)
